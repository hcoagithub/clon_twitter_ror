...
class TwittersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create twitter" do
    assert_difference("Twitter.count") do
      post twitters_url, params: { twitter: { description: @twitter.description, user_name: @twitter.user_name } }
    end
  ...
  test "should update twitter" do
    patch twitter_url(@twitter), params: { twitter: { description: @twitter.description, user_name: @twitter.user_name } }
